...
pub struct Labels {
    ...
    pub edit: &'static str,
    pub new: &'static str,
    pub could_not_remove_keybinding: &'static str,
    ...
    pub hint: &'static str,
    pub import_team: &'static str,
    pub empty_directory: &'static str,
    pub up_one_level: &'static str,
    pub invalid_file_name: &'static str,
    pub team_already_exists: &'static str,
    pub export: &'static str,
    pub operation_successful: &'static str,
    pub set_over: &'static str,
    ...
    pub positiveness: &'static str,
    pub total: &'static str,
    pub errors: &'static str,
    pub unforced: &'static str,
    ...
    pub partials: &'static str,
    pub substitutions: &'static str,
    pub finals: &'static str,
    pub tot: &'static str,
    pub pt: &'static str,
    pub won_lost: &'static str,
    pub err: &'static str,
    pub pos_perc: &'static str,
    pub prf_perc: &'static str,
    pub eff_perc: &'static str,
    pub pt_perc: &'static str,
    pub blk: &'static str,
    pub unf: &'static str,
    pub flt: &'static str,
    pub breaks_per_point: &'static str,
    pub sideouts_per_point: &'static str,
    pub counter_attack_conversion_rate: &'static str,
    pub sideout: &'static str,
    pub sideout_on_first_rally: &'static str,
...
const EN: Labels = Labels {
    ...
    edit: "edit",
    new: "new",
    could_not_remove_keybinding: "could not remove keybinding",
    ...
    empty_directory: "the directory is empty",
...
const IT: Labels = Labels {
    ...
    edit: "modifica",
    new: "nuovo",
    could_not_remove_keybinding: "impossibile rimuovere la scorciatoia",
    ...
    hint: "suggerimento",
    import_team: "importa squadra",
    empty_directory: "la directory è vuota",
    up_one_level: "su di un livello",
    invalid_file_name: "nome file non valido",
    team_already_exists: "squadra già esistente",
    export: "esporta",
    operation_successful: "operazione completata",
    ...
    positiveness: "positività",
    total: "totale",
    errors: "errori",
    unforced: "non forzati",
    points: "punti",
    summary: "riepilogo",
